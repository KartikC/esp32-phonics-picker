...
/**
 * @brief Set the DAC volume register directly.
 *
 * The legacy 0-100 helper above maps linearly to the register and is not a
 * perceptual percentage. Use this entry point when matching an
 * esp_codec_dev-calibrated board volume.
 *
 * @param dev ES8311 handle
 * @param[in] value Raw ES8311 DAC_REG32 value
 * @return
 *     - ESP_OK success
 *     - Else fail
 */
